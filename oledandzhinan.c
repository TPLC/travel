...
P4MDIN=0XFF;
P4MDOUT=0XD1;   //1000 0101


XBR0=0X01;      ////TX0£ºP04¡¢RX0£ºP05		
XBR1=0XC2;      //CEX0\CEX1      T0-P07
XBR2=0X01;
}
void pio2(void)
{
...
//delay_ms(20);
	...
	while(1)////////////////////////////////////////OLEDµÄ¶Ë¿Ú»¹Î´ÉèÖÃ 
	{		
	cnt=0;                                                    
	   	//SeriPushSend(0X31);
	   Send_byte(0X31);                                       //·¢ËÍ1Ö¡¶ÁÈ¡ÃüÁî¡£
	//SBUF1=0X31;  
	while(1)
	{
	  if(SCON1&0X01)
      ...
      if(cnt>=8)/////////////³ýÁË8ÒÔÍâµÄÊý¶¼²»ÄÜÊä³öÕý³£Öµ
      {
      break;
      }  
	}
	...
	//delay_ms(50);
	OLED_Clear();
        OLED_ShowChar(40,6,BUF[2],16);
 OLED_ShowChar(48,6,BUF[3],16);
  OLED_ShowChar(56,6,BUF[4],16);
	OLED_ShowChar(64,6,BUF[5],16);
		OLED_ShowChar(72,6,BUF[6],16);
